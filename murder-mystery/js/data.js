  ...
  C: {
    ...
    relationships: {
      G: {
        ...
        other: [],
        work: "Manager for Lover’s Retreat",
        impression: `Originally, just a woman who follows the rules. After finding out her secret, you're angry this murderer is living normally.`,
        history: [],
        dayOfTheMurder: [
          "Pharmacist Evelyn overheard and recorded Host Gen being involved in some accident 8 years ago.",
          "Found multiple clues (red Mercedes, blackbox recording, cloud keychain) that point to Host Gen being the driver in the hit-and-run.",
          "Discovered that Host Gen hit Cadie.",
          "Killed Host Gen and reclaimed the cloud keychain."
        ]
      },
      E: {
        ...
        other: ["Grew up in Mid Village", "Attends physiotherapy sessions for hand tremors and takes muscle relaxing medicine", "Dreamt of becoming a surgeon","Recently depressed about alumni gathering of former surgeon friends."],
        work: "Pharmacist",
        impression: `Strong-willed. Sensitive about hand tremors. You care for her very much.`,
        history: [
          {
            title: `Missing Sister - Hit-and-Run`,
          ...
          {
            title: `Bonding over loss`,
            description: `For over a year, you searched for Cadie together. Got close and started dating.`
          },
        ],
        dayOfTheMurder: ["Saw pictures of alumni gathering", "Recorded Host G arguing with someone about an accident 8 years ago.", "Argued over reporting to police", "Attended physiotherapy session"]
      },
      A: {
        name: "Heiress Allison", 
        personalDetails: {
      ...
      D: {
        ...
        personalDetails: {
          ...
          birthDate: "1990-02-14",
          age: 35,
          relStatus: ["First time meeting at the Retreat","Dating Heiress Allison"],
        },
        other: [],
        work: "Owner of CGG (Cars Gotta Go), a scrapyard business",
        impression: "Rough and gangster-like man.",
